export const artistApprovedEmail = (artistName: string): string => {
    return `
        <!DOCTYPE html>
        <html>
            <head>
            ...
            <body>
                <div class="container">
                    <p class="header"> Welcome to Dodbaa, ${artistName}!</p>
                    <p class="message">
                        Your artist application has been approved.
                        Now you can sell your merchandise on Dodbaa.
                    </p>
                    <a class="button" href="https://dodbaa.com/dashboard">
                        Go to Dashboard
                    </a>
                    <p class="footer">
